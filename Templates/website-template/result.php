...
<?php
    if($_SERVER['REQUEST_METHOD'] === 'POST')
    {
        ...
        if(!in_array($course, $Courses)) {
            ...
            if(!($course === 'fyimp'))
            {
                $SQL_QUERY = "SELECT STUDENTS.REGISTER_NUMBER, STUDENTS.NAME, RESULT_MASTERS.$sem FROM STUDENTS, RESULT_MASTERS WHERE STUDENTS.BATCH = '$batch' AND STUDENTS.COURSE = '$course';";
            } else {
                $SQL_QUERY = "SELECT STUDENTS.REGISTER_NUMBER, STUDENTS.NAME, RESULT_INTEGRATED.$sem FROM STUDENTS, RESULT_INTEGRATED WHERE STUDENTS.BATCH = '$batch' AND STUDENTS.COURSE = '$course';";
            }
